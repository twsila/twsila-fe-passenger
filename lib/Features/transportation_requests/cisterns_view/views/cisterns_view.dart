...
class CisternsView extends StatefulWidget {
  const CisternsView({Key? key}) : super(key: key);

  @override
  State<CisternsView> createState() => _CisternsViewState();
}

class _CisternsViewState extends State<CisternsView> {
  CisternsViewModel _viewModel = CisternsViewModel();
